...
#' This index was invented by McCormick, Cappella, Hughes, Gallagher (2015). DOI: 10.1177/0272431614547051. During the developement of the IOIindex this index was used for validation. Thus both indices, the IOIindex and McCormick's index, should usually correlate moderately. Further explanations regardings this index can be found in the
#' corresponding paper.
#'
